  ...
  module Plugin
    module LdapAdmin
      ...
      def self.registered(app)
        ...
        ldap_options = plugin_settings = app.settings.plugins['ldap_admin']['encryption']
        ...
        ldap_settings = {
          ...
          :encryption => {
            :method       => plugin_settings['encryption']['method'],
            :tls_options  => {
              :ca_file     => plugin_settings['encryption']['ca_file'],
            },
          },
          :auth       => {
            :method   => :simple,
